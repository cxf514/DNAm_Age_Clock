...
write.table(results_table,file="paired-t-tests-raw.txt",sep="\t",row.names = F,col.names = T)
...
# revise cpg names
cpg_names <- c(
  'Cluster_2', 'CpG_1', 'CpG_2', 'Cluster_6',
  'CpG_9', 'Cluster_7', 'CpG_7', 'Cluster_3',
  'CpG_6', 'CpG_4', 'CpG_5', 'CpG_8', 'Cluster_1',
  'CpG_3', 'Cluster_4', 'Cluster_5', 'CpG_10'
)

write.table(lasso_summary,file="feature_frequency_lasso_raw.txt",sep="\t",row.names = F,col.names = T)
write.table(rlasso_summary,file="feature_frequency_rlasso_raw.txt",sep="\t",row.names = F,col.names = T)
...
ggsave("cpg_formal_nonrm.pdf",width = 190, height = 110, units = "mm") 
save.image(file = 'cpg_formal_nonrm.Rdata')
