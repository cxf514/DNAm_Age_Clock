...
age_threshold <- 50     # Threshold for age grouping
...
# 7. Save Outputs ---------------------------------------------------------
write.table(test_results, "seed46/SVR_overall_vs_segmented.txt", sep = "\t", row.names = FALSE)
ggsave("seed46/SVR_overall_vs_segmented.pdf", final_plot, width = 7, height = 9)
save.image('seed46/SVR_overall_vs_segmented.RData')